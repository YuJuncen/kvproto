...
const (
	MigrationVersion_Base         MigrationVersion = 0
	MigrationVersion_AllowNewSSTs MigrationVersion = 1
)
...
func (m *AddSSTFilesRef) Reset()         { *m = AddSSTFilesRef{} }
func (m *AddSSTFilesRef) String() string { return proto.CompactTextString(m) }
func (*AddSSTFilesRef) ProtoMessage()    {}
func (*AddSSTFilesRef) Descriptor() ([]byte, []int) {
	return fileDescriptor_483d1f48d58a4885, []int{56}
}
func (m *AddSSTFilesRef) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AddSSTFilesRef) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AddSSTFilesRef.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AddSSTFilesRef) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AddSSTFilesRef.Merge(m, src)
}
func (m *AddSSTFilesRef) XXX_Size() int {
	return m.Size()
}
func (m *AddSSTFilesRef) XXX_DiscardUnknown() {
	xxx_messageInfo_AddSSTFilesRef.DiscardUnknown(m)
}

var xxx_messageInfo_AddSSTFilesRef proto.InternalMessageInfo

func (m *AddSSTFilesRef) GetPath() string {
	if m != nil {
		return m.Path
	}
	return ""
...
type AddSSTFiles struct {
	AddSstFile           []*AddSSTFile `protobuf:"bytes,1,rep,name=add_sst_file,json=addSstFile,proto3" json:"add_sst_file,omitempty"`
	Forzen               bool          `protobuf:"varint,2,opt,name=forzen,proto3" json:"forzen,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}

func (m *AddSSTFiles) Reset()         { *m = AddSSTFiles{} }
func (m *AddSSTFiles) String() string { return proto.CompactTextString(m) }
func (*AddSSTFiles) ProtoMessage()    {}
func (*AddSSTFiles) Descriptor() ([]byte, []int) {
	return fileDescriptor_483d1f48d58a4885, []int{57}
}
func (m *AddSSTFiles) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AddSSTFiles) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AddSSTFiles.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AddSSTFiles) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AddSSTFiles.Merge(m, src)
}
func (m *AddSSTFiles) XXX_Size() int {
	return m.Size()
}
func (m *AddSSTFiles) XXX_DiscardUnknown() {
	xxx_messageInfo_AddSSTFiles.DiscardUnknown(m)
}

var xxx_messageInfo_AddSSTFiles proto.InternalMessageInfo

func (m *AddSSTFiles) GetAddSstFile() []*AddSSTFile {
	if m != nil {
		return m.AddSstFile
	}
	return nil
...
func (m *AddSSTFiles) GetForzen() bool {
	if m != nil {
		return m.Forzen
	}
	return false
...
type AddSSTFile struct {
	AsIfTs               uint64   `protobuf:"varint,1,opt,name=as_if_ts,json=asIfTs,proto3" json:"as_if_ts,omitempty"`
...
func (m *AddSSTFile) Reset()         { *m = AddSSTFile{} }
func (m *AddSSTFile) String() string { return proto.CompactTextString(m) }
func (*AddSSTFile) ProtoMessage()    {}
func (*AddSSTFile) Descriptor() ([]byte, []int) {
	return fileDescriptor_483d1f48d58a4885, []int{58}
}
func (m *AddSSTFile) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AddSSTFile) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AddSSTFile.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AddSSTFile) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AddSSTFile.Merge(m, src)
}
func (m *AddSSTFile) XXX_Size() int {
	return m.Size()
}
func (m *AddSSTFile) XXX_DiscardUnknown() {
	xxx_messageInfo_AddSSTFile.DiscardUnknown(m)
}

var xxx_messageInfo_AddSSTFile proto.InternalMessageInfo

func (m *AddSSTFile) GetAsIfTs() uint64 {
	if m != nil {
		return m.AsIfTs
	}
	return 0
...
func (m *AddSSTFile) GetFile() *File {
	if m != nil {
		return m.File
	}
	return nil
...
type Migration struct {
	// The metadata of the creator of the migration.
	Creator     []string             `protobuf:"bytes,5,rep,name=creator,proto3" json:"creator,omitempty"`
	Version     MigrationVersion     `protobuf:"varint,7,opt,name=version,proto3,enum=backup.MigrationVersion" json:"version,omitempty"`
	...
	//
	AddSstFiles          []*AddSSTFilesRef `protobuf:"bytes,6,rep,name=add_sst_files,json=addSstFiles,proto3" json:"add_sst_files,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *Migration) GetAddSstFiles() []*AddSSTFilesRef {
	if m != nil {
		return m.AddSstFiles
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*AddSSTFilesRef)(nil), "backup.AddSSTFilesRef")
	proto.RegisterType((*AddSSTFiles)(nil), "backup.AddSSTFiles")
	proto.RegisterType((*AddSSTFile)(nil), "backup.AddSSTFile")
...
var fileDescriptor_483d1f48d58a4885 = []byte{
	...
	,
}
...
func (m *AddSSTFilesRef) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AddSSTFilesRef) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AddSSTFilesRef) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AddSSTFiles) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AddSSTFiles) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AddSSTFiles) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.AddSstFile) > 0 {
		for iNdEx := len(m.AddSstFile) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.AddSstFile[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *AddSSTFile) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AddSSTFile) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AddSSTFile) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Migration) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AddSstFiles) > 0 {
		for iNdEx := len(m.AddSstFiles) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.AddSstFiles[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.Creator) > 0 {
		for iNdEx := len(m.Creator) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintBrpb(dAtA, i, uint64(len(m.Creator[iNdEx])))
			i--
			dAtA[i] = 0x2a
		}
	}
...
func (m *AddSSTFilesRef) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AddSSTFilesRef) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AddSSTFilesRef: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AddSSTFilesRef: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *AddSSTFiles) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AddSSTFiles: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AddSSTFiles: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AddSstFile", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AddSstFile = append(m.AddSstFile, &AddSSTFile{})
			if err := m.AddSstFile[len(m.AddSstFile)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Forzen", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *AddSSTFile) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AddSSTFile: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AddSSTFile: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *Migration) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AddSstFiles", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AddSstFiles = append(m.AddSstFiles, &AddSSTFilesRef{})
			if err := m.AddSstFiles[len(m.AddSstFiles)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
