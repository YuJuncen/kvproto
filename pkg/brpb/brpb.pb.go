...
func (CompressionType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_brpb_f7f779231d0b3329, []int{0}
}

type BackupFormat int32

const (
	BackupFormat_ROCKS_SST BackupFormat = 0
	BackupFormat_KVSTREAM  BackupFormat = 1
)

var BackupFormat_name = map[int32]string{
	0: "ROCKS_SST",
	1: "KVSTREAM",
}
var BackupFormat_value = map[string]int32{
	"ROCKS_SST": 0,
	"KVSTREAM":  1,
}

func (x BackupFormat) String() string {
	return proto.EnumName(BackupFormat_name, int32(x))
}
func (BackupFormat) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_brpb_f7f779231d0b3329, []int{1}
}
...
func (*MetaFile) Descriptor() ([]byte, []int) {
	return fileDescriptor_brpb_f7f779231d0b3329, []int{2}
}
...
func (*Schema) Descriptor() ([]byte, []int) {
	return fileDescriptor_brpb_f7f779231d0b3329, []int{3}
}
...
func (*RawRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_brpb_f7f779231d0b3329, []int{4}
}
...
func (*ClusterIDError) Descriptor() ([]byte, []int) {
	return fileDescriptor_brpb_f7f779231d0b3329, []int{5}
}
...
func (*Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_brpb_f7f779231d0b3329, []int{6}
}
...
type BackupRequest struct {
	...
	SkipChecksum         bool         `protobuf:"varint,14,opt,name=skip_checksum,json=skipChecksum,proto3" json:"skip_checksum,omitempty"`
	Format               BackupFormat `protobuf:"varint,15,opt,name=format,proto3,enum=backup.BackupFormat" json:"format,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
...
func (*BackupRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_brpb_f7f779231d0b3329, []int{7}
}
...
func (m *BackupRequest) GetSkipChecksum() bool {
	if m != nil {
...
func (m *BackupRequest) GetFormat() BackupFormat {
	if m != nil {
		return m.Format
	}
	return BackupFormat_ROCKS_SST
}
...
func (*StorageBackend) Descriptor() ([]byte, []int) {
	return fileDescriptor_brpb_f7f779231d0b3329, []int{8}
}
...
func (*Noop) Descriptor() ([]byte, []int) {
	return fileDescriptor_brpb_f7f779231d0b3329, []int{9}
}
...
func (*Local) Descriptor() ([]byte, []int) {
	return fileDescriptor_brpb_f7f779231d0b3329, []int{10}
}
...
func (*S3) Descriptor() ([]byte, []int) {
	return fileDescriptor_brpb_f7f779231d0b3329, []int{11}
}
...
func (*GCS) Descriptor() ([]byte, []int) {
	return fileDescriptor_brpb_f7f779231d0b3329, []int{12}
}
...
func (*Bucket) Descriptor() ([]byte, []int) {
	return fileDescriptor_brpb_f7f779231d0b3329, []int{13}
}
...
func (*CloudDynamic) Descriptor() ([]byte, []int) {
	return fileDescriptor_brpb_f7f779231d0b3329, []int{14}
}
...
func (*BackupResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_brpb_f7f779231d0b3329, []int{15}
}
...
type ScanRegionRequest struct {
	ByKey                []byte   `protobuf:"bytes,1,opt,name=by_key,json=byKey,proto3" json:"by_key,omitempty"`
...
func (m *ScanRegionRequest) Reset()         { *m = ScanRegionRequest{} }
func (m *ScanRegionRequest) String() string { return proto.CompactTextString(m) }
func (*ScanRegionRequest) ProtoMessage()    {}
func (*ScanRegionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_brpb_f7f779231d0b3329, []int{16}
}
func (m *ScanRegionRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ScanRegionRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ScanRegionRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *ScanRegionRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ScanRegionRequest.Merge(dst, src)
}
func (m *ScanRegionRequest) XXX_Size() int {
	return m.Size()
}
func (m *ScanRegionRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ScanRegionRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ScanRegionRequest proto.InternalMessageInfo

func (m *ScanRegionRequest) GetByKey() []byte {
	if m != nil {
		return m.ByKey
	}
	return nil
...
func (m *ScanRegionRequest) GetConcurrency() int32 {
	if m != nil {
		return m.Concurrency
	}
	return 0
...
type ScanRegionResponse struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *ScanRegionResponse) Reset()         { *m = ScanRegionResponse{} }
func (m *ScanRegionResponse) String() string { return proto.CompactTextString(m) }
func (*ScanRegionResponse) ProtoMessage()    {}
func (*ScanRegionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_brpb_f7f779231d0b3329, []int{17}
}
func (m *ScanRegionResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ScanRegionResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ScanRegionResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *ScanRegionResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ScanRegionResponse.Merge(dst, src)
}
func (m *ScanRegionResponse) XXX_Size() int {
	return m.Size()
}
func (m *ScanRegionResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ScanRegionResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ScanRegionResponse proto.InternalMessageInfo

type StopScanRegionRequest struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *StopScanRegionRequest) Reset()         { *m = StopScanRegionRequest{} }
func (m *StopScanRegionRequest) String() string { return proto.CompactTextString(m) }
func (*StopScanRegionRequest) ProtoMessage()    {}
func (*StopScanRegionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_brpb_f7f779231d0b3329, []int{18}
}
func (m *StopScanRegionRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *StopScanRegionRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_StopScanRegionRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *StopScanRegionRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StopScanRegionRequest.Merge(dst, src)
}
func (m *StopScanRegionRequest) XXX_Size() int {
	return m.Size()
}
func (m *StopScanRegionRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_StopScanRegionRequest.DiscardUnknown(m)
}

var xxx_messageInfo_StopScanRegionRequest proto.InternalMessageInfo

type StopScanRegionResponse struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *StopScanRegionResponse) Reset()         { *m = StopScanRegionResponse{} }
func (m *StopScanRegionResponse) String() string { return proto.CompactTextString(m) }
func (*StopScanRegionResponse) ProtoMessage()    {}
func (*StopScanRegionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_brpb_f7f779231d0b3329, []int{19}
}
func (m *StopScanRegionResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *StopScanRegionResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_StopScanRegionResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *StopScanRegionResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StopScanRegionResponse.Merge(dst, src)
}
func (m *StopScanRegionResponse) XXX_Size() int {
	return m.Size()
}
func (m *StopScanRegionResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_StopScanRegionResponse.DiscardUnknown(m)
}

var xxx_messageInfo_StopScanRegionResponse proto.InternalMessageInfo
...
func (*ExternalStorageRestoreRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_brpb_f7f779231d0b3329, []int{20}
}
...
func (*ExternalStorageRestoreResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_brpb_f7f779231d0b3329, []int{21}
}
...
func (*ExternalStorageSaveRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_brpb_f7f779231d0b3329, []int{22}
}
...
func (*ExternalStorageSaveResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_brpb_f7f779231d0b3329, []int{23}
}
...
func init() {
	...
	proto.RegisterType((*ScanRegionRequest)(nil), "backup.ScanRegionRequest")
	proto.RegisterType((*ScanRegionResponse)(nil), "backup.ScanRegionResponse")
	proto.RegisterType((*StopScanRegionRequest)(nil), "backup.StopScanRegionRequest")
	proto.RegisterType((*StopScanRegionResponse)(nil), "backup.StopScanRegionResponse")
	...
	proto.RegisterEnum("backup.BackupFormat", BackupFormat_name, BackupFormat_value)
}
...
type BackupClient interface {
	...
	DebugScanRegion(ctx context.Context, in *ScanRegionRequest, opts ...grpc.CallOption) (*ScanRegionResponse, error)
	DebugStopScanRegion(ctx context.Context, in *StopScanRegionRequest, opts ...grpc.CallOption) (*StopScanRegionResponse, error)
}
...
func (c *backupClient) DebugScanRegion(ctx context.Context, in *ScanRegionRequest, opts ...grpc.CallOption) (*ScanRegionResponse, error) {
	out := new(ScanRegionResponse)
	err := c.cc.Invoke(ctx, "/backup.Backup/DebugScanRegion", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *backupClient) DebugStopScanRegion(ctx context.Context, in *StopScanRegionRequest, opts ...grpc.CallOption) (*StopScanRegionResponse, error) {
	out := new(StopScanRegionResponse)
	err := c.cc.Invoke(ctx, "/backup.Backup/DebugStopScanRegion", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BackupServer interface {
	...
	DebugScanRegion(context.Context, *ScanRegionRequest) (*ScanRegionResponse, error)
	DebugStopScanRegion(context.Context, *StopScanRegionRequest) (*StopScanRegionResponse, error)
}
...
func _Backup_DebugScanRegion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ScanRegionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BackupServer).DebugScanRegion(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/backup.Backup/DebugScanRegion",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackupServer).DebugScanRegion(ctx, req.(*ScanRegionRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Backup_DebugStopScanRegion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StopScanRegionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BackupServer).DebugStopScanRegion(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/backup.Backup/DebugStopScanRegion",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackupServer).DebugStopScanRegion(ctx, req.(*StopScanRegionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Backup_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "DebugScanRegion",
			Handler:    _Backup_DebugScanRegion_Handler,
		},
		{
			MethodName: "DebugStopScanRegion",
			Handler:    _Backup_DebugStopScanRegion_Handler,
		},
	},
...
func (m *BackupRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Format != 0 {
		dAtA[i] = 0x78
		i++
		i = encodeVarintBrpb(dAtA, i, uint64(m.Format))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *ScanRegionRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ScanRegionRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.ByKey) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintBrpb(dAtA, i, uint64(len(m.ByKey)))
		i += copy(dAtA[i:], m.ByKey)
	}
	if m.Concurrency != 0 {
		dAtA[i] = 0x10
		i++
...
func (m *ScanRegionResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ScanRegionResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *StopScanRegionRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *StopScanRegionRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *StopScanRegionResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *StopScanRegionResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ScanRegionRequest) Size() (n int) {
	var l int
	_ = l
	l = len(m.ByKey)
	if l > 0 {
...
func (m *ScanRegionResponse) Size() (n int) {
	var l int
	_ = l
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
...
func (m *StopScanRegionRequest) Size() (n int) {
	var l int
	_ = l
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
...
func (m *StopScanRegionResponse) Size() (n int) {
	var l int
	_ = l
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	...
	for iNdEx < l {
		...
		case 15:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Format |= (BackupFormat(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ScanRegionRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ScanRegionRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ScanRegionRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ByKey", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ByKey = append(m.ByKey[:0], dAtA[iNdEx:postIndex]...)
			if m.ByKey == nil {
				m.ByKey = []byte{}
			}
			iNdEx = postIndex
...
func (m *ScanRegionResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ScanRegionResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ScanRegionResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *StopScanRegionRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StopScanRegionRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StopScanRegionRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *StopScanRegionResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StopScanRegionResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StopScanRegionResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func init() { proto.RegisterFile("brpb.proto", fileDescriptor_brpb_f7f779231d0b3329) }

var fileDescriptor_brpb_f7f779231d0b3329 = []byte{
	...
	,
}
